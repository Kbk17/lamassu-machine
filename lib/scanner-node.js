...
const scanMainQR = ({ cryptoCode, stillsCallback, resultCallback }) => {
  ...
  getBarcode()
    .then((barcode) => {
      ...
      // Log scanned wallet address for debugging
      console.log('[SCANNER] Scanned wallet address:', barcode);
