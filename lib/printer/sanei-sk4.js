...
const printReceipt = (data, printerCfg, receiptConfig) => {
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      // Receipt header z dodatkowym odstępem
      ...
      // Adres podzielony na dwie linie
      cmd.push('Adres: Plaszowska 21,\n')
      cmd.push('Krakow, 30-713\n')
      ...
      // Wyświetl dane klienta tylko jeśli nie jest to "Anonymous"
